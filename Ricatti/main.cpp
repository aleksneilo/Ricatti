...
int main()
{
    ...
    N_S = int(5 * N_Mid); N_F = int(0.5 * N_Mid); N_S1 = int(0.2 * N_Mid); N_F1 = int(0.6 * N_Mid); N_S2 = int(2.8 * N_Mid); N_N = int(5 * N_Mid);
                ...
                if (culc == 1)
                {
                        ...
                        //if ((abs(I - 0.) < 1e-5)|| (abs(I - 0.1) < 1e-5) || (abs(I - 0.3) < 1e-5) )
                    {
                        ...
                        while ((dqmax > epsq))//&&(iterq==0))
                        {
                            ...
                            //SelfConsParal_ricatti(G, DelP, 0, qP, I);
                            iter1 = iter;
